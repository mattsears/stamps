...
class RequestTest < Test::Unit::TestCase
	context "get_authenticator_token" do
      ...
      setup do
        ...
        with(:body => "<?xml version=\"1.0\" encoding=\"UTF-8\"?><soap:Envelope xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:tns=\"http://stamps.com/xml/namespace/2010/11/swsim/swsimv29\" xmlns:soap=\"http://schemas.xmlsoap.org/soap/envelope/\"><soap:Body><tns:AuthenticateUser><tns:Credentials><tns:IntegrationID>XXXXXXX-XXXX-XXXX-XXXX-XXXXXXXXXXXX</tns:IntegrationID><tns:Username>USERNAME</tns:Username><tns:Password>PASSXXXX</tns:Password></tns:Credentials></tns:AuthenticateUser></soap:Body></soap:Envelope>", 
        :headers => {'Accept'=>'*/*', 'Content-Type'=>'text/xml;charset=UTF-8', 'Soapaction'=>'http://stamps.com/xml/namespace/2010/11/swsim/swsimv29/AuthenticateUser', 'User-Agent'=>'Ruby'}).
